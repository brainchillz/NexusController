...
OFF unless CONTROLLER_SSO_ISSUER is set, and off is the default everywhere. A
...
# Self-contained on purpose: app.py imports this module, so importing its
# helpers back would be circular. These three mirror app.py exactly.
DATA_DIR = os.environ.get('CONTROLLER_DATA_DIR',
...
SSO_ISSUER = os.environ.get('CONTROLLER_SSO_ISSUER', '').rstrip('/')
SSO_PUBKEY = os.environ.get('CONTROLLER_SSO_PUBKEY', '')
SSO_KID = os.environ.get('CONTROLLER_SSO_KID', '')
...
# registers.
SSO_AUDIENCE = os.environ.get('CONTROLLER_SSO_AUDIENCE', '')
...
SSO_AUTO_REDIRECT = env_bool('CONTROLLER_SSO_AUTO_REDIRECT', False)
